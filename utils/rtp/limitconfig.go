...
type LimitConfig struct {
	...
	MonthlyPlayerProfitLowerLimitEnabled bool  `yaml:"monthly_player_profit_limit_enabled"` // 當月個人盈利上限功能
	MonthlyPlayerRTPLowerLimit           int64 `yaml:"monthly_player_rtp_lower_limit"`      // 當月個人RTP下限（分）

	// RakeEnabled     bool `yaml:"rake_enabled"`     // 抽水功能
	// CashbackEnabled bool `yaml:"cashback_enabled"` // 補水功能
}
